...
function App() {
  ...
  return (
    <div className="h-screen bg-slate-900">
      <div className="max-w-4*l mx-auto pt-20 px-6">
        <h1 className="text-3*l text-slate-100 mb-4">La To-do liste</h1>
        ...
        <ul>
          {todoList.length === 0 && (
            <li className="text-slate-50 text-md">Aucun item à afficher...</li>
          )}
          {todoList.length > 0 && 
          todoList.map(item => (
